...
DELIMITER //
CREATE PROCEDURE `deleta_banda`(idbanda int)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `update_banda`(nome varchar(45), integrantes int, ranking int, genero int, idbanda int)
BEGIN
